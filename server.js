...
if (!fs.existsSync('.data/database.db')) {
  ...
  db.prepare("INSERT INTO likes VALUES ( 1000000, '1', ?)").run(moment().format());
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    db.prepare("INSERT INTO likes VALUES ( '1000001', '2', ?)").run(moment().add(1, 's').format());
    db.prepare("INSERT INTO likes VALUES ( '1000000', '2', ?)").run(moment().add(2, 's').format());
